  ...
  try {
    const seedData = {
      ...
      contact_section: {
        ...
        form_enabled: true,
        phone_no: "+971589278718",
        email: "support@bluetikapi.com"
      },
      footer_section: {
        ...
        social_links: [{
          twitter: "https://twitter.com/bluetikapi",
          linkedin: "https://linkedin.com/company/bluetikapi",
          facebook: "https://facebook.com/bluetikapi",
          instagram: "https://instagram.com/bluetikapi"
        }],
        copy_rights_text: "© 2026 BLUETIK API. A Project of Zamzam Electronics. All rights reserved."
      }
    };
    ...
    console.log('Landing page seeded/updated successfully!');
  } catch (error) {
