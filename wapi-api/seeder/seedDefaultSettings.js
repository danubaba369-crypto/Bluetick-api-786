...
async function seedDefaultSettings() {
  try {
    ...
    const seedData = {
      app_name: 'BLUETIK API',
      app_loader: "One And Only",
      app_description: 'Whatsapp Marketing Platform',
      app_email: 'support@bluetikapi.com',
      support_email: 'support@bluetikapi.com',
      ...
      mail_from_name: 'BLUETIK API',
      mail_from_email: process.env.SMTP_USER || 'noreply@bluetikapi.com',
      ...
      connection_method: ['manual', 'qr_scan', 'embedded_signup'],
