...
async function seedCurrency() {
  try {
    const currencies = [
      ...
      { name: 'Indian Rupee', code: 'INR', symbol: '₹', exchange_rate: 83.0, decimal_number: 2, sort_order: 4, is_active: true, is_default: false },
      ...
      { name: 'United Arab Emirates Dirham', code: 'AED', symbol: 'د.إ', exchange_rate: 3.67, decimal_number: 2, sort_order: 13, is_active: true, is_default: true },
