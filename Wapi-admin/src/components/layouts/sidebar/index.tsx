...
export default function Sidebar() {
  ...
  const sidebarLogo = useMemo(() => {
    ...
    if (isVisuallyCollapsed) {
      return (
        (isDark
          ? settings?.sidebar_light_logo_url
          : settings?.sidebar_dark_logo_url) || "/assets/logos/sidebarLogo.png"
      );
    }

    return (
      (isDark ? settings?.logo_light_url : settings?.logo_dark_url) ||
      (isDark ? "/assets/logos/logo1.png" : "/assets/logos/logo3.png")
    );
