      ...
      <div className="relative z-10 mx-[calc(16px+(195-16)*((100vw-320px)/(1920-320)))]">
        <div className="p-4 text-center">
          ...
          {data.cta_button?.text && (
            <Button
              className="mt-6! w-full! h-14! rounded-lg! trasition-all duration-300 bg-primary! px-10! py-4! text-[16px]! font-semibold! text-white! shadow-lg! transition-transform hover:scale-105 hover:bg-primary-hover! sm:w-auto!"
              onClick={() => {
                if (isAuthenticated) {
