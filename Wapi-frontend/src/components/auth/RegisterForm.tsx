...
export const RegisterPage = () => {
  ...
  const { allow_user_signup, authPageSetup } = useAppSelector((state) => state.setting);
          ...
          <div className="bg-white lg:rounded-r-3xl shadow-2xl p-8 lg:p-10 flex flex-col justify-center relative lg:col-span-3 min-h-200">
            ...
            <div className="relative z-10 max-w-2xl mx-auto w-full">
              <div className="lg:hidden flex items-center justify-center mb-8">
                <DynamicLogo width={220} height={58} className="h-14 w-auto object-contain mx-auto" skeletonClassName="h-14 w-44 mx-auto" />
              </div>

              <div className="mb-8">
                <h2 className="text-3xl text-slate-900 mb-2">{isAuthSetupLoading ? <Skeleton className="h-9 w-48" /> : content.title}</h2>
                <div className="text-slate-600">{isAuthSetupLoading ? <Skeleton className="h-5 w-64" /> : content.subtitle}</div>
              </div>
              ...
              <form onSubmit={formik.handleSubmit} className="space-y-5">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2 flex flex-col">
                    ...
                    <div className="relative group">
                      ...
                      <Input id="phone" name="phone" type="number" placeholder={t("phone_placeholder")} value={formik.values.phone} onChange={(e) => formik.setFieldValue("phone", e.target.value.replace(/\D/g, ""))} onBlur={formik.handleBlur} className="pl-12 h-12 border border-slate-200 focus:border-emerald-500 rounded-lg" />
                    </div>
                ...
                <Button type="submit" className="w-full h-13 mt-4 bg-primary text-white rounded-lg shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40 transition-all text-base font-semibold group" disabled={isLoading || formik.isSubmitting || !allRequirementsMet || !passwordsMatch || isAuthSetupLoading}>
