    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-emerald-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl">
        <div className="grid lg:grid-cols-2 gap-0 items-stretch">
          ...
          <div className="bg-white lg:rounded-r-3xl shadow-2xl p-4 sm:p-12 min-h-175 flex flex-col justify-center relative">
                    ...
                    <div className="text-slate-600">
                      {isAuthSetupLoading ? (
                        ...
                        <>
                          ...
                          {!token && <span className="font-semibold text-slate-900 ml-1">{email}</span>}
                        </>
                      )}
                    </div>
                  </div>
