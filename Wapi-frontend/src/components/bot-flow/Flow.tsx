  ...
  const handleSave = async () => {
    try {
      ...
      const getFormattedNode = (node: any) => {
        ...
        let type = nodeType === "delay" ? "delay" : nodeType === "wait_for_reply" ? "wait_for_reply" : nodeType === "api" || nodeType === "api_request" ? "api" : nodeType === "response_saver" ? "response_saver" : nodeType === "condition" ? "condition" : ["send_template", "cta_button", "assign_chatbot", "save_to_google_sheet", "create_calendar_event", "add_tag", "webhook", "form_flow", "update_contact"].includes(nodeType) ? nodeType : nodeType === "add_segment" ? "add_to_segment" : "send_message";
