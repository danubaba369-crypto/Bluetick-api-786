...
const QuickReplySettingsModal = ({ isOpen, onClose }: QuickReplySettingsModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-150 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white dark:bg-(--card-color) rounded-xl shadow-2xl w-full max-w-md overflow-hidden border border-slate-200 dark:border-(--card-border-color) animate-in fade-in zoom-in-95 duration-200">
        {/* Header */}
