    ...
    try {
      ...
      if (localMedia.length > 0) {
        ...
        if (localMedia.length === 1 && remoteMedia.length === 0) {
          ...
          if (currentReplyToMessage?.wa_message_id) {
            formData.append("replyMessageId", currentReplyToMessage.wa_message_id);
          }
          ...
          const payload: SendMessagePayload = {
            ...
            replyMessageId: currentReplyToMessage?.wa_message_id,
