...
const ComingSoonTemplate: React.FC<ComingSoonTemplateProps> = ({ title, description, icon, featureName }) => {
  ...
  return (
    <ProductLayout>
      <div className="min-h-[85vh] flex flex-col items-center justify-center px-[calc(14px+10*((100vw-320px)/1600))]   text-center relative overflow-hidden bg-white">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="flex items-center justify-center mb-8 flex-wrap gap-3">
          ...
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="text-[calc(18px+23*((100vw-320px)/1600))] font-black text-slate-900 leading-[1.05] tracking-tight mb-[calc(20px+12*((100vw-320px)/1600))]">
            {title}
          </motion.h1>

          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="text-[calc(14px+4*((100vw-320px)/1600))] text-slate-600 leading-relaxed mb-[calc(24px+24*((100vw-320px)/1600))] max-w-2xl mx-auto font-medium">
            {description}
          </motion.p>

          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="flex flex-col items-center gap-[calc(6px+18*((100vw-320px)/1600))]">
      ...
      {/* Benefits section */}
      <section className="py-[calc(25px+47*((100vw-320px)/1600))] bg-slate-50 border-t border-slate-100">
        <div className="container mx-auto px-[calc(14px+10*((100vw-320px)/1600))]  max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-slate-600 leading-relaxed">{app_name || t("app_name")} is an official WhatsApp Business Solution Provider, ensuring your data is always secure and compliant.</p>
            </div>
          </div>
        </div>
      </section>
