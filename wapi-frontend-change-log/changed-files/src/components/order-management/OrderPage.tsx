...
import { Edit3, Eye, MessageSquareCode } from "lucide-react";
...
const OrderPage = () => {
  ...
  const columns: Column<Order>[] = [
    ...
    },
    {
      ...
      sortKey: "status",
      cell: (row) => (
        <Badge variant={getStatusVariant(row?.status) as any} className="capitalize font-black px-3 py-1 dark:bg-(--page-body-bg) dark:hover:bg-(--table-hover)">
