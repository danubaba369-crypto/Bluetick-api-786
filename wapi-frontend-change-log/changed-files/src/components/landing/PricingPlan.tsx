                      ...
                      <div className={`flex flex-col flex-1 p-[calc(20px+(28-20)*((100vw-320px)/(1920-320)))] ${plan!.is_featured ? "bg-white rounded-[32px]" : ""}`}>
                        ...
                        <div className="mt-auto space-y-3">
                          <Button
                            ...
                            className={`w-full rounded-xl py-3 px-3 text-[15px] h-[46px] font-bold transition-all duration-300 ${plan!.is_featured ? "bg-primary text-white shadow-lg shadow-primary/20 hover:bg-[var(--primary-hover)]" : "bg-primary text-white hover:bg-[var(--primary-hover)]"}`}
                          >
                            Choose Plan
                          </Button>
                          {plan!.is_featured && (
