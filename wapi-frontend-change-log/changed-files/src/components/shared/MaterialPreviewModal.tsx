    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-[min(95vw,400px)] bg-transparent border-none shadow-none p-0 flex flex-col items-center justify-center overflow-visible">
        ...
        <div className="w-full relative">
          ...
          <FormLivePreview templateType={templateType} headerText={headerText} messageBody={messageBody} variables_example={material.variables_example || []} footerText={footerText} buttons={buttons} headerFile={null} mediaUrl={mediaUrl} marketingType={marketingType} offerText={material.offer_text} />
        </div>
      </DialogContent>
    </Dialog>
  );
