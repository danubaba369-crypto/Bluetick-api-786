...
const BroadcastPage = () => {
  ...
  return (
    <ProductLayout>
      <ProductPageTemplate
        hero={{
          badge: `${setting.app_name || t("app_name")} for Marketing`,
        ...
        finalCTA={{
          ...
          description: "WhatsApp CRM Broadcasts achieve up to 98% open rates compared to traditional email marketing.",
